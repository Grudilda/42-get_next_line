...
/*   Updated: 2024/06/25 21:43:26 by grudilda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** The FD_MAX macro is arbitrary because the limit of file descriptor
** on my machine is 9223372036854775807 (LLONG_MAX)
** and on school machines is 9223372036854775807 (LLONG_MAX)
** one can find it with the command < cat /proc/sys/fs/file-max >
*/
# define FD_MAX 1024
...
/***********************************/
/*     GET_NEXT_LINE_BONUS FILE    */
/***********************************/

/*
** @brief __get_next_line__ is a function that returns a
** line read from a file descriptor. With the array [stash] it can
** reads from several files descriptor without overwrite one another.
...
/*****************************************/
/*     GET_NEXT_LINE_UTILS_BONUS FILE    */
/*****************************************/
...
**t he character is not found. The terminating null byte is
